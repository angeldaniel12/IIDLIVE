...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <!--<li class="nav-item">
          <a class="nav-link active" href="admin.principal.videosR">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link " href="{{route('Todas')}}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-camera text-secondary text-sm opacity-10"></i>
            </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Lives</h6>
        </nav>

        <!-- Buscador -->
        <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto" action="{{ route('search') }}" method="POST">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                ...
                <img alt="Image placeholder" src="{{ asset('uploads/avatars/'.Auth::user()->fotos) }}" class="avatar avatar-sm me-3">
  ...
  <div class="fixed-plugin">
    <a class="fixed-plugin-button text-dark position-fixed px-3 py-2">
      <i class="">
      <img img src="{{ asset('img/IIDLIVE.png')}}" width="50" height="50">
      </i>
    </a>
