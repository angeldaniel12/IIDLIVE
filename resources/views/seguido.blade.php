              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <!-- lista de seguidores -->
                    <p class="text-uppercase text-sm text-muted mb-4">Seguidos</p>
            ...
            <div class="card mb-3" style="max-width: 540px;">
                      ...
                      @if(auth()->user()->isFollowing($followerd))
                          <form method="post" action="{{ route('unfollow', $followerd) }}">
                              @csrf
                              <button class="btn btn-sm btn-danger" type="submit"><i class="fa fa-user-xmark"></i>Dejar seguir</button>
                          </form>
                      @else
                          <form method="post" action="{{ route('follow', $followerd) }}">
                              @csrf
                              <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-user-plus"></i> Seguir</button>
                          </form>
                      @endif
                    @endif
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">jdsndfnsjdnf</p>
